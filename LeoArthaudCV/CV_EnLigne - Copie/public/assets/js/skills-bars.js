...
$.getScript( url, function(){
    ...
    ShowSemicircles(document.getElementById('hcPackOffice'),'#00459c',0.80);
    ShowSemicircles(document.getElementById('hcPhpStorm'),'#be05c2',0.75);
    ShowSemicircles(document.getElementById('hcVisual'),'#7100c2',0.60);
    ShowSemicircles(document.getElementById('hcUnity3D'),'#9c0014',0.60);
